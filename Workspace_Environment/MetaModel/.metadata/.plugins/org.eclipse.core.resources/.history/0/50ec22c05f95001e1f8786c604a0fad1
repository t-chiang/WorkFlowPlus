...
/**
 * This is the item provider adapter for a {@link org.mcmaster.workflowplus.wfp.WorkFlowPlusRoot} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class WorkFlowPlusRootItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	 ...
	 * @generated
	 */
	public WorkFlowPlusRootItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(WfpPackage.Literals.WORK_FLOW_PLUS_ROOT__NODE);
			childrenFeatures.add(WfpPackage.Literals.WORK_FLOW_PLUS_ROOT__REFERENCE);
			childrenFeatures.add(WfpPackage.Literals.WORK_FLOW_PLUS_ROOT__WORKFLOW);
		}
	...
	/**
	 * This returns WorkFlowPlusRoot.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/WorkFlowPlusRoot"));
	}
	...
	public String getText(Object object) {
		return getString("_UI_WorkFlowPlusRoot_type");
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(WorkFlowPlusRoot.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(WfpPackage.Literals.WORK_FLOW_PLUS_ROOT__WORKFLOW,
				WfpFactory.eINSTANCE.createWorkFlow()));
	}
