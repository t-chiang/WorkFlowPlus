...
/**
 * This is the item provider adapter for a {@link org.mcmaster.workflowplus.wfp.Inheritance} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class InheritanceItemProvider extends ReferenceItemProvider {
	/**
	...
	protected void addSrcPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						WfpPackage.Literals.INHERITANCE__SRC, true, false, true, null, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Inheritance_tgt_feature",
								"_UI_Inheritance_type"),
						WfpPackage.Literals.INHERITANCE__TGT, true, false, true, null, null, null));
	}
