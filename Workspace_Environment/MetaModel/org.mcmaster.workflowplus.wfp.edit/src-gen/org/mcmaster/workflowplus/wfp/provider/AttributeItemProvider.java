...
/**
 * This is the item provider adapter for a {@link org.mcmaster.workflowplus.wfp.Attribute} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AttributeItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Attribute_name_feature",
								"_UI_Attribute_type"),
						WfpPackage.Literals.ATTRIBUTE__NAME, true, false, false,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Attribute_description_feature",
								"_UI_Attribute_type"),
						WfpPackage.Literals.ATTRIBUTE__DESCRIPTION, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	public void notifyChanged(Notification notification) {
		...
		case WfpPackage.ATTRIBUTE__NAME:
		case WfpPackage.ATTRIBUTE__DESCRIPTION:
