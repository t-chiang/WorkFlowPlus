...
/**
 * This is the item provider adapter for a {@link org.mcmaster.workflowplus.wfp.Process} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ProcessItemProvider extends NodeItemProvider {
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Process_input_feature",
								"_UI_Process_type"),
						WfpPackage.Literals.PROCESS__INPUT, true, false, true, null, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Process_output_feature",
								"_UI_Process_type"),
						WfpPackage.Literals.PROCESS__OUTPUT, true, false, true, null, null, null));
	}
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						WfpPackage.Literals.PROCESS__NAME, true, false, false,
	...
	public String getText(Object object) {
		String label = ((org.mcmaster.workflowplus.wfp.Process) object).getName();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(org.mcmaster.workflowplus.wfp.Process.class)) {
