...
/**
 * This is the item provider adapter for a {@link wFP_V2.Process} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ProcessItemProvider extends NodeItemProvider {
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						WFP_V2Package.Literals.PROCESS__NAME, true, false, false,
	...
	protected void addNextPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Process_next_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Process_next_feature", "_UI_Process_type"),
						WFP_V2Package.Literals.PROCESS__NEXT, true, false, true, null, null, null));
	}
	...
	protected void addPreviousPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Process_previous_feature"),
	...
	public String getText(Object object) {
		String label = ((wFP_V2.Process) object).getName();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(wFP_V2.Process.class)) {
