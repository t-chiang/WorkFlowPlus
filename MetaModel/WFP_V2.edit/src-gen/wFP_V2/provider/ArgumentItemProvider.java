...
/**
 * This is the item provider adapter for a {@link wFP_V2.Argument} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Argument_name_feature",
								"_UI_Argument_type"),
						WFP_V2Package.Literals.ARGUMENT__NAME, true, false, false,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Argument_description_feature",
								"_UI_Argument_type"),
						WFP_V2Package.Literals.ARGUMENT__DESCRIPTION, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Argument_constraint_feature",
								"_UI_Argument_type"),
						WFP_V2Package.Literals.ARGUMENT__CONSTRAINT, true, false, true, null, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Argument_constructs_feature",
								"_UI_Argument_type"),
						WFP_V2Package.Literals.ARGUMENT__CONSTRUCTS, true, false, true, null, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Argument_constructedBy_feature",
								"_UI_Argument_type"),
						WFP_V2Package.Literals.ARGUMENT__CONSTRUCTED_BY, true, false, true, null, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Argument_syntactic_feature",
								"_UI_Argument_type"),
						WFP_V2Package.Literals.ARGUMENT__SYNTACTIC, true, false, false,
